...
const createOrUpdate = async (credentials) => {
    ...
    // see https://github.com/Azure/azure-sdk-for-node/blob/master/lib/services/serviceBusManagement2/lib/operations/queues.js#L2909
    const options = {
        rights: process.env.rights.split(' '),
    };

    await azureArmSb.queues.createOrUpdateAuthorizationRule(
